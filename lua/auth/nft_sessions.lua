...
add_authenticated4 = function(ip, ttl)
  return run_nft("add element ip " .. tostring(NFT_TABLE) .. " " .. tostring(NFT_SET4) .. " { " .. tostring(ip) .. " timeout " .. tostring(ttl) .. "s }")
end
local del_authenticated4
del_authenticated4 = function(ip)
  return run_nft("delete element ip " .. tostring(NFT_TABLE) .. " " .. tostring(NFT_SET4) .. " { " .. tostring(ip) .. " }")
end
local add_authenticated6
add_authenticated6 = function(ip, ttl)
  return run_nft("add element ip6 " .. tostring(NFT_TABLE) .. " " .. tostring(NFT_SET6) .. " { " .. tostring(ip) .. " timeout " .. tostring(ttl) .. "s }")
end
local del_authenticated6
del_authenticated6 = function(ip)
  return run_nft("delete element ip6 " .. tostring(NFT_TABLE) .. " " .. tostring(NFT_SET6) .. " { " .. tostring(ip) .. " }")
end
