return {
  ...
  nfqueue = {
    ...
    captive = {
      ...
      hint = "n° de file, ex: 20",
      default = "20"
    },
    reject = {
      type = "string",
      label = "Paquets à rejeter",
      hint = "n° de file, ex: 10-11",
      default = "10-11"
    },
    auth = {
      type = "string",
      label = "Handshakes TLS (auth)",
      hint = "n° de file, ex: 5",
      default = "5"
    },
    sni = {
    ...
    sip = {
      type = "string",
      label = "Trafic SIP/STUN",
      hint = "n° de file, ex: 12",
      default = "12"
    }
  },
  dns = {
  ...
  second_opinion = {
    ...
    resolvers = {
      ...
      hint = "IP v4 et v6 mélangées ; famille choisie selon le paquet"
    },
    budget_ms = {
      type = "integer",
      label = "Budget d'attente (ms)",
      default = 80,
      hint = "au-delà : fail-open (réponse d'origine intacte)"
    },
    fail_open = {
      type = "boolean",
      label = "Fail-open",
      default = true,
      hint = "pas de réponse validateur à temps → laisser passer"
    }
  },
  nft = {
    ...
    table = {
      ...
      default = "dns-filter-bridge"
    },
    ip_timeout = {
      type = "string",
      label = "Durée des autorisations IP",
      hint = "ex: 2m, 300s",
      default = "2m"
    },
    sip_session_ttl = {
      type = "string",
      label = "Durée des sessions SIP",
      hint = "ex: 5m",
      default = "5m"
    },
    add_backoff_ms = {
      type = "string",
      label = "Délais de réessai (ms)",
      hint = "liste, ex: {20,50,200,400,800,2000}",
      default = "{20,50,200,400,800,2000}"
    },
    add_failure_policy = {
      type = "enum",
      label = "En cas d'échec d'ajout",
      values = {
        "fail-closed",
        "fail-open"
      },
    ...
    ack_timeout_ms = {
      type = "integer",
      label = "Délai d'attente confirmation (ms)",
      default = 150
    }
  },
  ipc = {
    ...
    pending_ttl = {
      type = "integer",
      label = "Durée de conservation d'une requête en attente (s)",
      default = 5
    },
    match_retry = {
  ...
  clients = {
    ...
    expiry = {
      type = "integer",
      label = "Expiration entrée client (s)",
      default = 300
    }
  },
  mac_learner = {
    ...
    query_sock = {
      type = "path",
      label = "Socket de communication interne",
      default = "/var/run/custos/mac_query.sock"
    },
    entry_ttl = {
      type = "integer",
      label = "Durée de mémorisation d'une MAC (s)",
      default = 900
    }
  },
  auth = {
    ...
    captive_port = {
      type = "integer",
      label = "Port HTTP portail captif",
      default = 33080
    },
    cert = {
      type = "path",
      label = "Certificat TLS (optionnel)"
    },
    key = {
      type = "path",
      label = "Clé privée TLS (optionnel)"
    },
    session_key = {
      type = "path",
      label = "Clé HMAC sessions",
      hint = "générée si absente",
      default = "/etc/custos/session.key"
    },
    secrets = {
      type = "path",
      label = "Fichier secrets",
      default = "/etc/custos/secrets"
    },
    sessions_file = {
      type = "path",
      label = "Fichier sessions",
      default = "/tmp/sessions.lua"
    },
    session_ttl = {
      type = "integer",
      label = "TTL session (s, 0=illimitée)",
      default = 0
    },
    heartbeat_interval = {
      type = "integer",
      label = "Intervalle heartbeat (s)",
      default = 30
    },
    idle_timeout = {
      type = "integer",
  ...
  doh = {
    ...
    upstream_timeout_ms = {
      type = "integer",
      label = "Timeout upstream (ms)",
      default = 2000
    },
    cert_path = {
      type = "path",
      label = "Certificat TLS DoH (optionnel)"
    },
    key_path = {
      type = "path",
      label = "Clé TLS DoH (optionnel)"
    },
    prefer_ipv6 = {
      type = "boolean",
      label = "Préférer IPv6",
  ...
  events = {
    ...
    dir = {
      type = "path",
      label = "Répertoire événements",
      default = "/tmp/custos/events"
    },
    max_age_hours = {
      type = "integer",
      label = "Conservation max (h)",
      hint = "168h = 7 jours",
      default = 168
    },
    min_free_pct = {
      type = "integer",
      label = "Espace libre min (%)",
      default = 30
    }
  },
  metrics = {
    ...
    enabled = {
      type = "boolean",
      label = "Activer métriques",
      default = true
    },
    flush_interval = {
      type = "integer",
      label = "Intervalle vidange (s)",
      default = 60
    },
    max_rules = {
      type = "integer",
      label = "Max règles tracées",
      default = 1000
    }
  },
  rtp = {
    ...
    excluded_ports = {
      type = "string_list",
      label = "Ports exclus du filtrage RTP",
      hint = "ex: {5060}",
      default = "{5060}"
    }
  },
  filter = {
    ...
    custom_lists_dir = {
      type = "path",
      label = "Répertoire listes personnalisées (optionnel)"
    },
    allow_localnets = {
      type = "boolean",
    ...
    allowed_domains = {
      type = "string_list",
      label = "Domaines autorisés par défaut",
      default = '{"local","lan","home.arpa"}'
    },
    nets = {
      type = "named_map",
      label = "Réseaux nommés",
      value_type = "string_list",
      hint = "alias → liste de CIDRs"
    },
    macs = {
      type = "named_map",
      label = "MACs nommées",
    ...
    times = {
      ...
      value_type = "time_window",
      hint = "nom → {HH:MM, HH:MM}"
    },
    users = {
      type = "named_map",
      label = "Utilisateurs",
    ...
    userlists = {
      type = "named_map",
      label = "Listes d'utilisateurs",
      value_type = "string_list",
      hint = "alias → liste d'emails"
    },
    decision = {
      _label = "Politique de décision",
      first_match_wins = {
        type = "boolean",
        label = "Première règle gagne (first-match)",
        default = true
      },
      continue_to_next_rule = {
        type = "boolean",
        label = "Continuer après match",
        default = false
      }
    },
    rules = {
