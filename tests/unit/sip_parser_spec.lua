return describe("sip.parser", function()
  local parser = require("sip.parser")
  return it("extracts media IPs from c=, a=rtcp and ICE candidates without duplicates", function()
    local msg = parser.parse([[SIP/2.0 183 Session Progress
...
a=candidate:2 1 UDP 2130706431 83.136.164.102 61348 typ host
    ...
    return assert.are.equal("83.136.162.33", msg.sdp_ips[2].ip)
  end)
end)
