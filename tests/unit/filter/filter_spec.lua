...
describe("filter.conditions.to_domain", function()
  local to_domain = (require("filter.conditions.to_domain")).factory
...
describe("filter.conditions.to_domains", function()
  local to_domains = (require("filter.conditions.to_domains")).factory
...
describe("filter.conditions.to_domainlist", function()
  local to_domainlist = (require("filter.conditions.to_domainlist")).factory
  local TMPDIR = "./tmp"
...
describe("filter.conditions.to_domainlists", function()
  local to_domainlists = (require("filter.conditions.to_domainlists")).factory
  local TMPDIR = "./tmp"
  before_each(function()
...
describe("filter.conditions.from_mac", function()
  local from_mac = (require("filter.conditions.from_mac")).factory
...
describe("filter.conditions.from_net", function()
  local from_net = (require("filter.conditions.from_net")).factory
...
describe("filter.conditions.from_user", function()
  local from_user = (require("filter.conditions.from_user")).factory
  ...
  it("mac=nil, src_ip=nil → safe_get_mac(nil) → retourne nil", function()
    ...
    local fu = (require("filter.conditions.from_user")).factory
...
describe("filter.conditions.stolen_computer", function()
  local stolen_computer = (require("filter.conditions.stolen_computer")).factory
...
describe("filter.actions.dnsonly", function()
  local dnsonly_action = (require("filter.actions.dnsonly")).factory
...
||DOUBLECLICK.NET^
  ...
  return it("is_valid", function()
    ...
    assert.is_true((is_valid("lan")))
    assert.is_true((is_valid("localhost")))
    assert.is_true((is_valid("xxx")))
...
return describe("filter.lib.load_config", function()
  ...
  it("auth defaults", function()
    ...
    return assert.equals("fail-closed", cfg.sni.nft_failure_policy)
  end)
