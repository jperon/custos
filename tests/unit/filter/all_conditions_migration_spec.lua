...
local expr_time, err_time = plan_time.rules[1].conditions_meta[1].compile_nft("inet")
...
local expr_domain, err_domain = plan_domain.rules[1].conditions_meta[1].compile_nft("inet")
