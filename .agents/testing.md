...
| `make test-e2e` | homelab libvirt | Suite E2E complète via les 3 VMs libvirt — groupes G0–G14 : DNS allow/block, EDE, auth/sessions, IPv6, DoH, interface admin webui `/admin/*`, **et inspection SNI TLS (`worker_tls`, mode strict-443)** (voir [libvirt/README.md](../libvirt/README.md)). |
